...
function playerGame(playerMove){
  ...
  document.querySelector('.js-pickups').innerHTML=`You <img src="/build/${playerMove}-emoji.png" alt="" class="move-css"> - <img src="/build/${computerMove}-emoji.png" alt="" class="move-css"> Computer`;
